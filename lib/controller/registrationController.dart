...
import 'package:hamco/components/externalDir.dart';
...
import 'package:hamco/model/sideMenuModel.dart';
import 'package:hamco/model/staffDetailsModel.dart';
import 'package:hamco/screen/dashboard/mainDashboard.dart';
import 'package:hamco/screen/login&registration/login.dart';
import 'package:hamco/services/dbHelper.dart';
        ...
        try {
          ...
          if (sof == "1") {
            ...
            if (appType == 'OA') {
              ...
              await HamcoDB.instance
                  .deleteFromTableCommonQuery("companyRegistrationTable", "");
              var res =
                  await HamcoDB.instance.insertRegistrationDetails(regModel);
  ...
  Future<StaffDetails?> getStaffDetails(String cid, int index) async {
    ...
    try {
      ...
      for (var staff in map) {
        ...
        restaff = await HamcoDB.instance.insertStaffDetails(staffModel);
      }
